/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env=dev --env-interface=BaseEnv` (hash: 8e62847b3d6ca0c102ff199eb27cd251)
...
interface __BaseEnv_BaseEnv {
	...
	AUTH_EMAIL_FROM: "logowanie@landingos.app";
	...
	DATA_SERVICE: Fetcher /* landingos-ds-dev */;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "AUTH_EMAIL_FROM" | "CLOUDFLARE_ENV" | "DATABASE_HOST" | "DATABASE_USERNAME" | "DATABASE_PASSWORD" | "BETTER_AUTH_SECRET" | "BETTER_AUTH_BASE_URL" | "VITE_DATA_SERVICE_URL" | "VITE_API_TOKEN" | "DATA_SERVICE_API_TOKEN">> {}
}
