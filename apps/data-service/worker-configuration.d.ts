/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env=dev --env-interface=BaseEnv` (hash: a580086fee27f812fe4f17bfa1bd5305)
// Runtime types generated with workerd@1.20260722.1 2026-05-25 nodejs_compat
interface __BaseEnv_BaseEnv {
	CLOUDFLARE_ENV: "dev";
	TRANSFER_CATALOG_FRESHNESS_DAYS: "30";
	...
	RATE_LIMITER_FAST: RateLimit;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "FlightRoomDurableObject";
	}
	interface Env extends __BaseEnv_BaseEnv {}
}
interface BaseEnv extends __BaseEnv_BaseEnv {}
type StringifyValues<EnvType extends Record<string, unknown>> = {
	[Binding in keyof EnvType]: EnvType[Binding] extends string ? EnvType[Binding] : string;
};
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "CLOUDFLARE_ENV" | "TRANSFER_CATALOG_FRESHNESS_DAYS" | "DATABASE_HOST" | "DATABASE_USERNAME" | "DATABASE_PASSWORD" | "BETTER_AUTH_SECRET" | "BETTER_AUTH_BASE_URL" | "API_TOKEN" | "ALLOWED_ORIGINS">> {}
}
